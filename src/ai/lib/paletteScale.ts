...
export function paletteScale(t: Theme, color: 'primary' | 'secondary' | 'grey' | 'warning' | 'error' | 'info' | 'success', shade: 50 | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900, fallback?: string): string {
