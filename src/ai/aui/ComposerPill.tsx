...
export function AuiComposerPill({ placeholder = AUI_ASSISTANT_PLACEHOLDER, followupPlaceholder = AUI_ASSISTANT_FOLLOWUP_PLACEHOLDER, onOpen }: AuiComposerPillProps) {
  ...
  return (
    <Paper
      ...
      // Como en el tablero: toda la píldora abre (los botones de adentro hacen lo suyo); el texto es el objetivo
      // accesible por teclado, no la píldora entera (que ya contiene botones reales).
