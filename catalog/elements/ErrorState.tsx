          ...
          <Box sx={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', p: 3 }}>
            <Stack spacing={1.5} sx={{ width: '100%', maxWidth: 460 }}>
              ...
              {phase === 'ok'
                ...
                : <ErrorState detail={DETAIL} retrying={phase === 'retrying'} onRetry={retry} />}
            </Stack>
          </Box>
        }
        properties={
...
export function ErrorStateCard() {
  ...
  return <ErrorState detail={DETAIL} retrying={retrying} onRetry={() => { setRetrying(true); after(RETRY_MS, () => setRetrying(false)); }} />;
}
